...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, FindPlaceFragment.newInstance("","")).commit();
        } else if (id == R.id.nav_createAd) {
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, CreateAdFragment.newInstance("","")).commit();
        } else if (id == R.id.nav_gallery) {
            //requestStoragePermission();
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, GalleryFragment.newInstance("","")).commit();
